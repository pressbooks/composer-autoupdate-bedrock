...
= 1.3.7 =
* [Misc] Update MIME database.
* [New] Added optional `LOTF_HIDE_MENUS` config constant to hide GUI.
...
= 1.3.7 =
This release updates the MIME database, and adds support for the new config constant `LOTF_HIDE_MENUS`, which if defined hides all LotF-related admin pages.
